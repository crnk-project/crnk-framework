...
public class NonReactiveButImmediateTest extends ReactiveTestBase {

	private ImmediateSlowResourceRepository repository = new ImmediateSlowResourceRepository();
