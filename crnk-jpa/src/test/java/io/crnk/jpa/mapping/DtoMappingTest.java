...
import io.crnk.jpa.model.dto.SequenceDTO;
...
public class DtoMappingTest extends AbstractJpaJerseyTest {
	...
	public void testCreateWithDTO() {
		ResourceRepositoryV2<SequenceDTO, Long> sequenceRepo = client.getRepositoryForType(SequenceDTO.class);
		SequenceDTO newSequence = new SequenceDTO();
		newSequence.setStringValue("ID is going to be autogenerated");
