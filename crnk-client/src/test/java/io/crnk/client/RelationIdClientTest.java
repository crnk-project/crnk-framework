 ...
 */
public class RelationIdClientTest extends AbstractClientTest {
	...
	public void setup() {
		...
		relRepo = client.getRepositoryForType(Schedule.class, Project.class);
	}
	...
	public void checkResourceIdentifierField() {
		...
		ResourceRepositoryV2<RelationIdTestResource, Serializable> repository =
				client.getRepositoryForType(RelationIdTestResource.class);
	...
	private Schedule checkPatchRelationship(Schedule schedule) {
		...
		RelationshipRepositoryV2<Schedule, Serializable, Project, Serializable> relRepository =
				client.getRepositoryForType(Schedule.class, Project.class);
