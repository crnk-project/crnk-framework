...
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/approval/ApprovalRepositoryDecorator.java[tags=docs_decorator]
----
...
.ApprovalRepositoryDecorator.java
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/approval/ApprovalRepositoryDecorator.java[tags=docs_save]
----
