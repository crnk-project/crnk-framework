...
IMPORTANT: Traditional and reactive-style programming are considered being equally important and both have their respective advantages and disadvantages. The reactive API
is by no means going to replace the traditional one!
...
----
include::../../../../crnk-servlet/src/test/java/io/crnk/servlet/resource/ReactiveServletTestApplication.java[tags=reactive]
----
