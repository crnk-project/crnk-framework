...
There is a Crnk client for Java projects to allow
...
----
include::../../../../crnk-client/src/test/java/io/crnk/client/mock/repository/ScheduleRepository.java[tags=doc]
----
...
.ScheduleRepository.java
----
include::../../../../crnk-client/src/test/java/io/crnk/client/mock/repository/ScheduleRepository.java[tags=annotation]
----
...
.ScheduleRepository.java
----
include::../../../../crnk-client/src/test/java/io/crnk/client/mock/repository/ScheduleRepository.java[tags=services]
----
