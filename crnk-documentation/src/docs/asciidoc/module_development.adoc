...
`HomeModule` make use of `ResourceFilterDirectory` obtained with `ModuleContext.getResourceFilterDirectory(...)` to
...
----
include::../../../../crnk-cdi/src/main/resources/META-INF/services/io.crnk.core.module.discovery.ServiceDiscovery[]
----
