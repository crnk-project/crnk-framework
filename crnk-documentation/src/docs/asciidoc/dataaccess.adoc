...
----
include::../../../../crnk-data/crnk-data-jpa/src/test/java/io/crnk/jpa/model/JpaTransientTestEntity.java[tags=docs]
----
...
Have a look at https://github.com/crnk-project/crnk-framework/blob/master/crnk-data/crnk-data-jpa/src/test/java/io/crnk/jpa/data/JpaQuerySpecEndToEndTest.java within the `crnk-data-jpa`
...
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/approval/ApprovalProcessInstance.java[tag=docs1]
	...
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/approval/ApprovalProcessInstance.java[tag=docs2]
----
...
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/model/ScheduleApprovalProcessInstance.java[tag=docs1]
	...
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/model/ScheduleApprovalProcessInstance.java[tag=docs2]
----
...
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/ApprovalTestApplication.java[tag=activitiModule]
----
...
.approval.bpmn20.xml
----
include::../../../../crnk-data-activiti/src/test/resources/approval.bpmn20.xml[]
----
...
.ApprovalTestApplication.java
----
include::../../../../crnk-data-activiti/src/test/java/io/crnk/activiti/example/ApprovalTestApplication.java[tag=approvalModule]
----
