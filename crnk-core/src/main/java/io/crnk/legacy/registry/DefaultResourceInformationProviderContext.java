...
public class DefaultResourceInformationProviderContext implements ResourceInformationProviderContext {
	...
	public DefaultResourceInformationProviderContext(ResourceInformationProvider provider, InformationBuilder informationBuilder, TypeParser typeParser, ObjectMapper objectMapper) {
