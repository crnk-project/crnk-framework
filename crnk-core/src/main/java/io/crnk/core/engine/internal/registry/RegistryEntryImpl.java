...
public class RegistryEntryImpl implements RegistryEntry {
    ...
    public <T, I extends Serializable> ResourceRepositoryV2<T, I> getResourceRepositoryFacade() {
        return (ResourceRepositoryV2) getFacade();
    }
     ...
     */
    public <T, I> ResourceRepository<T, I> getFacade() {
        return (ResourceRepositoryV2) new ResourceRepositoryFacade(this, moduleRegistry);
    }
