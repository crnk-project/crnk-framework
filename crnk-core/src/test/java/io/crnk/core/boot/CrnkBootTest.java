...
public class CrnkBootTest {
    ...
    public void testDiscoverDeserializer() {
        ...
        DefaultQuerySpecUrlMapper instance = new DefaultQuerySpecUrlMapper();
        Mockito.when(serviceDiscovery.getInstancesByType(eq(QuerySpecUrlMapper.class)))
                .thenReturn(Arrays.asList(instance));
        boot.boot();
        Assert.assertSame(instance, boot.getUrlMapper());
    }
    ...
    public void setAllowUnknownAttributesDefaultQuerySpecDeserializer() {
        ...
        DefaultQuerySpecUrlMapper querySpecDeserializer = (DefaultQuerySpecUrlMapper) boot.getUrlMapper();
    ...
    @Test
    public void setAllowUnknownParametersDefault() {
        CrnkBoot boot = new CrnkBoot();
        boot.setAllowUnknownParameters();
        boot.boot();
