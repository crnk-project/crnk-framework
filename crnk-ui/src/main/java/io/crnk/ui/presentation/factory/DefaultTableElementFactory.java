...
public class DefaultTableElementFactory implements PresentationElementFactory {
    ...
    private void buildColumn(PresentationEnvironment env, TableColumnsElement columns, MetaResource resource, boolean filtersEnabled, boolean sortingEnabled, ArrayDeque<MetaAttribute> attributePath) {
        ...
        if (type instanceof MetaDataObject && !lastAttribute.isAssociation()) {
            ...
            PresentationEnvironment cellEnv = new PresentationEnvironment();
            cellEnv.setEditable(false);
