...
public class RelationshipPost extends AbstractNestedMutateOperation implements OASOperation {

  public static OperationType operationType = OperationType.POST;

  public RelationshipPost(MetaResource metaResource, MetaResourceField metaResourceField, MetaResource relatedMetaResource) {
