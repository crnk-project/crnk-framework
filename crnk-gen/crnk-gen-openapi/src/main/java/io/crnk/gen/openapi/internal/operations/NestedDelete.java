...
public class NestedDelete extends AbstractNestedDeleteOperation implements OASOperation {

  public NestedDelete(MetaResource metaResource, MetaResourceField metaResourceField, MetaResource relatedMetaResource) {
